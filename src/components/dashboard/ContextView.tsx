...
export function ContextView({ context }: { context: string }) {
  ...
  // Atrasadas: due_date < hoy. Se separan en dos buckets:
  // - depende_vos: status que requiere acción del usuario
  // - esperando_vencida: status de espera (WAITING_STATES)
  // Ambas se excluyen del agrupado por status/cliente para no duplicar.
